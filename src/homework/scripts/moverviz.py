...
class MoveBaseSquare():
    def __init__(self):
        ...
        square_size = rospy.get_param("~square_size", 1.0)  # 正方形大小
        quaternions = list()  # 角度数据
        euler_angles = (pi/2, pi, 3*pi/2, 0)  # 机器人方向
        ...
        i = 0  # 计数器
        while i < 4 and not rospy.is_shutdown():  # 发布位置
