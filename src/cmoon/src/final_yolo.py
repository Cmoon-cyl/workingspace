...
def detect(img):
    ...
    cv2.imwrite(path + '/rubbish.jpg', ros_image)
    a = cv2.waitKey(1)
...
if __name__ == '__main__':
    ...
    path = os.path.dirname(os.path.dirname(__file__)) + '/src/minyolo5/weights'
    weights = path + '/yolov5s_old.pt'
    imgsz = 640
