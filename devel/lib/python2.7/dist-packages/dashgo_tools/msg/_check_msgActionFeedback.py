...
"""autogenerated by genpy from dashgo_tools/check_msgActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class check_msgActionFeedback(genpy.Message):
    _md5sum = "203dd24393c91eea77ca877dc2c41d6e"
    _type = "dashgo_tools/check_msgActionFeedback"
...
"""
    ...
    _slot_types = ['std_msgs/Header', 'actionlib_msgs/GoalStatus', 'dashgo_tools/check_msgFeedback']
    ...
    def __init__(self, *args, **kwds):
        ...
        """
        if args or kwds:
            super(check_msgActionFeedback, self).__init__(*args, **kwds)
            ...
            if self.feedback is None:
                self.feedback = dashgo_tools.msg.check_msgFeedback()
        else:
            self.header = std_msgs.msg.Header()
            self.status = actionlib_msgs.msg.GoalStatus()
            self.feedback = dashgo_tools.msg.check_msgFeedback()
    ...
    def deserialize(self, str):
        ...
        try:
            ...
            (self.feedback.accomplished,) = _get_struct_f().unpack(str[start:end])
            return self
