...
"""autogenerated by genpy from dashgo_tools/check_msgActionResult.msg. Do not edit."""
import codecs
import sys
...
class check_msgActionResult(genpy.Message):
    _md5sum = "1cae2fb189668c0268eda667eb28a594"
    _type = "dashgo_tools/check_msgActionResult"
...
"""
    ...
    _slot_types = ['std_msgs/Header', 'actionlib_msgs/GoalStatus', 'dashgo_tools/check_msgResult']
    ...
    def __init__(self, *args, **kwds):
        ...
        """
        if args or kwds:
            super(check_msgActionResult, self).__init__(*args, **kwds)
            ...
            if self.result is None:
                self.result = dashgo_tools.msg.check_msgResult()
        else:
            self.header = std_msgs.msg.Header()
            self.status = actionlib_msgs.msg.GoalStatus()
            self.result = dashgo_tools.msg.check_msgResult()
    ...
    def deserialize(self, str):
        ...
        try:
            ...
            (self.result.issuccess,) = _get_struct_B().unpack(str[start:end])
            self.result.issuccess = bool(self.result.issuccess)
            return self
